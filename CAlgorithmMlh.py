...
class CAlgorithmMlh(CAlgorithmBase):
    ...
    def _calculate_coefficients(self):
        covariance = np.cov(self._training_event_collection.photon_timestamps[:, :self.photon_count], rowvar=0)
    ...
    def evaluate_collection_timestamps(self, event_collection):
        ...
        timestamps = np.dot(event_collection.photon_timestamps[:, :current_mlh_length], self._mlh_coefficients)
