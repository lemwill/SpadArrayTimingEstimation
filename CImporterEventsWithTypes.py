...
class CImporterEventsWithTypes(CImporterBase):
    ...
    def import_data(self, filename, event_count=0, event_skip=0):
        ...
        timestamps = imported_data[:, 3:128+3] - 50000
        initial_trigger_types = imported_data[:, 128+3:256+3]
        initial_x_coord = imported_data[:, 256+3:384+3]
        initial_y_coord = imported_data[:, 374+3:512+3]
